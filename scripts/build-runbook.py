...
SCRIPTS = [
    ...
    {
        "path": "agents/windows/Install-WazuhAgent.ps1",
        "title": "Install-WazuhAgent.ps1",
        "where": "на каждом контроллере домена, от администратора",
        "what": "Ставит агент Wazuh. Идемпотентен: на машине с уже "
                "установленной нужной версией завершается сразу, поэтому "
                "годится и для раскатки групповой политикой. Группу "
                "определяет сам по роли машины, если не указана явно.",
    },
    {
